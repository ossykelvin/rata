...
The overlay character is event-driven. The original `public/rata-concept.png` crop is the temporary art for every state; a missing file falls back to a letter-mark silhouette. See `docs/CHARACTER-ASSETS.md`.
